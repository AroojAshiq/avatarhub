  ...
  return (
    <section className="md:px-14 px-7 py-10 text-black-600 body-font flex items-center relative z-0">
      <div className=" flex xl:flex-row w-full flex-col  justify-between gap-12 choose container ">
        <div className=" xl:order-first order-last justify-center w-full grid xl:grid-cols-3 md:grid-cols-3 sm:grid-col-1 3xl:gap-40 2xl:gap-x-16 xl:gap-x-7 xl:gap-y-12 gap-y-5 lg:gap-x-16 lg:gap-y-20 md:gap-x-6 sm:gap-y-8">
